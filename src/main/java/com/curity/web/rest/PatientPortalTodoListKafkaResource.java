...
@RestController
@RequestMapping("/api/patient-portal-todo-list-kafka")
public class PatientPortalTodoListKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PatientPortalTodoListKafkaResource.class);
    ...
    public PatientPortalTodoListKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
